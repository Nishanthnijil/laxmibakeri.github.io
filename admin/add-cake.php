...
else
{
    ...
    $query=mysqli_query($con, "insert into tblfood(CategoryName,ItemName,ItemGST,ItemPrice,ItemDes,ItemQty,Weight,Image) value('$fcat','$itemname','$itemgst','$price','$description','$quantity','$weight','$itempic')");
    if ($query) {
      ...
      $query=mysqli_query($con,"select * from  tblcategory");
              ...
              <option value="<?php echo $row['CategoryName'];?>"><?php echo $row['CategoryName'];?></option>
                  <?php } ?>  
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">GST:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="ItemGST" required="true"></div>
