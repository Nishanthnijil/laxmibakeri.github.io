                          ...
                          <tr>
                            ...
                            <td>
                              <select name="status" class="form-control wd-450" required="true">
                                ...
                                <option value="Cake being Prepared">Item being Prepared</option>
                                <option value="Cake Pickup">Item Picked Up</option>
                                <option value="Cake Delivered">Item Delivered</option>
                              </select>
                            </td>
                          </tr>
                          <tr align="center">
