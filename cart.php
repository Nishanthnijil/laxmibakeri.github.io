...
<head>
        ...
        <title>Lakshmi Bakers || cart Page</title>
...
$query=mysqli_query($con,"select tblfood.Image,tblfood.ItemName,tblorders.Ordquan,tblfood.ItemGST,tblfood.ItemDes,tblfood.Weight,tblfood.ItemPrice,tblorders.FoodId,tblorders.ID from tblorders join tblfood on tblfood.ID=tblorders.FoodId where tblorders.UserId='$userid' and tblorders.IsOrderPlaced is null");
...
?>
                ...
                <div class="form-group row"><label class="col-sm-2 col-form-label"></label>
                                                <div class="col-sm-10"><select class="form-control white_bg" required="true" name="Ordquan" onchange='this.form.submit()'>
...
<?php $total=$row['ItemPrice']?>

								<td>Rs <?php echo $total ?></td>
                <td> <?php echo $gst=$row['ItemGST']?></td>
                <?php $gst=$total*($gst/100);?>
                <td>
									<?php echo $row['Weight']?>
									</select>
								</td>
								<td>Rs <?php echo $total+$gst ?></td>
									<?php 
$grandtotal+=$total;
$grandgst+=$gst;
...
$cnt=$cnt+1; 
 ...
 <?php $gst=$total*($gst/100);?>
                  ...
                  <div class="GST">
        						<h5>GST <span>Rs <?php echo $grandgst;?>
                             </span></h5>
        					</div>
        					<div class="total">
        						<h4>Total <span>Rs <?php echo $grandtotal+$grandgst;?></span></h4>
        					</div>
