...
<head>
        <title>Lakshmi Bakers || Checkout Page</title>
                		...
                		<div class="order_box_price">
							...
							<div class="payment_list">
								<div class="price_single_cost">
									...
									<?php 
$userid= $_SESSION['fosuid'];
$query=mysqli_query($con,"select tblfood.Image,tblfood.ItemName,tblfood.ItemDes,tblfood.Weight,tblfood.ItemPrice,tblfood.ItemGST,tblfood.ItemQty,tblorders.FoodId from tblorders join tblfood on tblfood.ID=tblorders.FoodId where tblorders.UserId='$userid' and tblorders.IsOrderPlaced is null");
...
$cnt=$cnt+1; 
 ...
 ?></span></h5><?php $cnt++; } }?>
                                    ...
                                    <h4>GST <span>Rs <?php echo $grandgst;?></span></h4>
									<h5>Shipping And Handling<span class="text_f">Free Shipping</span></h5>
									<h3>Total <span>Rs <?php echo $grandtotal+$grandgst;?></span></h3>
								</div>
