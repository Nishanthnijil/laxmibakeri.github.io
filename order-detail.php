...
<head>
        ...
        <title>Lakshmi Bakers || Order Detail</title>
        ...
        <section class="cart_table_area p_100">
        	<div class="container">
				<div class="table-responsive">
                    <h4 style="color: palevioletred;text-align: center;">Your Order Details</h4>
<h3>
...
<p>
 <a href="javascript:void(0);" onClick="popUpWindow('invoice.php?oid=<?php echo $oid;?>&&odate=<?php echo $od;?>');" title="Order Invoice" style="color:#000" class="btn pest_btn">  Invoice</a></p>
					<?php 
                                $userid= $_SESSION['fosuid'];
 $query=mysqli_query($con,"select tblfood.Image,tblfood.ItemName,tblfood.Weight,tblfood.ItemPrice,tblfood.ItemGST,tblorders.FoodId,tblorders.OrderNumber,tblorders.CashonDelivery from tblorders join tblfood on tblfood.ID=tblorders.FoodId where tblorders.UserId='$userid' and tblorders.OrderNumber=$oid");
...
<td>
<img class="b-goods-f__img img-scale" src="admin/itemimages/<?php echo $row['Image'];?>" alt="<?php echo $row['Image'];?>" width='80' height='80'></td>
...
<th>₹ <?php echo $grandtotal+$grandgst;?></th>
</tr>
